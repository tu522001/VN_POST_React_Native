...
const BottomNavigation: React.FC = () => {
    ...
    const renderTabItem = (name: string, component: React.ComponentType<any>, image: any, text: string, statusBarColor: string) => {
        return (
            <Tab.Screen
                name={name}
                component={component}
    ...
    return (
        <Tab.Navigator
            ...
            {renderTabItem("Documents", ContestScreen, documentsImage, "Cuộc thị", "#FFFFFF")}
            {renderTabItem("Course", CourseScreen, courseImage, "Khoá học", "#FFFFFF")}
            {renderTabItem("Contest", DocumentsScreen, contestImage, "Tài liệu", "#FFFFFF")}
